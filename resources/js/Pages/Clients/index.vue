    ...
    <AuthenticatedLayout>
      <div class="container-md mx-auto p-8 w-3/4 mt-4">
        <div class="flex justify-between items-center mb-3">
          ...
          <button @click="openModal('Created new Client.')" class="text-black rounded-lg border-2 border-solid hover:border-blue-500 hover:bg-gray-50 hover:text-gray-700 px-3 py-1 bg-gray-50">+ Add Client</button>
        </div>
